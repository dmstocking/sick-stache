...
public class CacheStatus {
	...
	public CacheStatus( CacheStatusJson json )
	{
		if ( json == null ) {
			// look at me assigning values to value types >.> C++ never leaves your bones
			banner = false;
			poster = false;
		} else {
			banner = json.banner.value;
			poster = json.poster.value;
		}
	}
}
